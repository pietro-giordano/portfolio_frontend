                  ...
                  <form action="#" method="post" class="w-full flex flex-col items-center">
                        <div ref="left1" class="sm w-full md:w-3/4 lg:w-2/3 flex flex-col md:flex-row items-center">
                              <input type="text" name="fullname" id="fullname" placeholder="Full Name"
                                    class="w-11/12 md:w-1/2 m-1 px-4 py-2 bg-grey border-2 border-orange-light rounded-lg text-orange-very placeholder:text-orange-very placeholder:text-sm focus:outline-none focus:border-orange-very">
                        ...
                        <div ref="right" class="sm w-full flex justify-center md:w-3/4 lg:w-2/3">
                              <textarea name="" id="" cols="30" rows="10" placeholder="Your Message"
                                    class="w-11/12 md:w-full m-1 px-4 py-2 bg-grey border-2 border-orange-light rounded-lg text-orange-very placeholder:text-orange-very placeholder:text-sm focus:outline-none focus:border-orange-very"></textarea>
                        </div>

                        <input ref="bottom" type="submit" value="Send Message"
                              class="sm block mt-3 md:mt-6 px-3 py-2 md:px-6 md:py-3 font-bold md:text-lg rounded-3xl text-bblack bg-orange-light shadow-o hover:shadow-none tracking-wider transition-shadow duration-500">
                  </form>
            </div>
